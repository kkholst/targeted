...
```
    ...
    ─────────────────────────────────────
              score    weight
    glm1 0.09612534 0.2205113
    glm2 0.10725898 0.0000000
    gam  0.09377275 0.7794887
...
```
    ...
    <bytecode: 0x55e14030b3b0>
    <environment: 0x55e145b693f0>
...
```
    ...
    5-fold cross-validation with 2 repetitions
               ...
               mse       mae
    glm 0.10705092 0.2124602
    gam 0.09679415 0.1858678
...
```
    ...
    ─────────────────────────────────────
            score    weight
    glm 0.1076386 0.6793261
    gam 0.1084101 0.3206739

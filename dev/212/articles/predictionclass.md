...
```
    ...
    ─────────────────────────────────────
              score    weight
    glm1 0.09663121 0.3774331
    glm2 0.10661877 0.1025430
    gam  0.09633405 0.5200239
...
```
    ...
    <bytecode: 0x5597c0fa5a28>
    <environment: 0x5597c5cc2c78>
...
```
    ...
    5-fold cross-validation with 2 repetitions
               ...
               mse       mae
    glm 0.10756723 0.2129436
    gam 0.09924247 0.1884703
...
```
    ...
    ─────────────────────────────────────
            score   weight
    glm 0.1074912 0.312542
    gam 0.1074602 0.687458

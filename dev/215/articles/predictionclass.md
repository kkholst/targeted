...
```
    ...
    ─────────────────────────────────────
              score    weight
    glm1 0.09794086 0.3150480
    glm2 0.10728885 0.1117773
    gam  0.09744318 0.5731746
...
```
    ...
    <bytecode: 0x55b44d18bf10>
    <environment: 0x55b450449b98>
...
```
    ...
    5-fold cross-validation with 2 repetitions
               ...
               mse       mae
    glm 0.10837276 0.2138996
    gam 0.09848183 0.1886557
...
```
    ...
    ─────────────────────────────────────
            score    weight
    glm 0.1065288 0.4257075
    gam 0.1064592 0.5742925

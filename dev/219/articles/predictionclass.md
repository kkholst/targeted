...
```
    ...
    ─────────────────────────────────────
              score     weight
    glm1 0.09978786 0.06007433
    glm2 0.10717820 0.12508079
    gam  0.09693613 0.81484488
...
```
    ...
    <bytecode: 0x55e60aa3f368>
    <environment: 0x55e60aeb81e8>
...
```
    ...
    5-fold cross-validation with 2 repetitions
               ...
               mse       mae
    glm 0.10719984 0.2128212
    gam 0.09905112 0.1887363
...
```
    ...
    ─────────────────────────────────────
            score     weight
    glm 0.1067187 0.91295714
    gam 0.1076444 0.08704286

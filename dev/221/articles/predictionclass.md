...
```
    ...
    ─────────────────────────────────────
              score    weight
    glm1 0.10008433 0.3836286
    glm2 0.10774092 0.1126492
    gam  0.09952708 0.5037222
...
```
    ...
    <bytecode: 0x55f0a80c74f8>
    <environment: 0x55f0aae3ac60>
...
```
    ...
    5-fold cross-validation with 2 repetitions
               ...
               mse       mae
    glm 0.10734236 0.2126595
    gam 0.09761586 0.1867764
...
```
    ...
    ─────────────────────────────────────
            score    weight
    glm 0.1065130 0.7794154
    gam 0.1066407 0.2205846

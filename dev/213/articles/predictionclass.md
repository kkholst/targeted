...
```
    ...
    ─────────────────────────────────────
              score     weight
    glm1 0.09663413 0.36180274
    glm2 0.10687510 0.07191129
    gam  0.09589294 0.56628597
...
```
    ...
    <bytecode: 0x563d817b6ca8>
    <environment: 0x563d84a98880>
...
```
    ...
    5-fold cross-validation with 2 repetitions
              ...
              mse       mae
    glm 0.1069583 0.2127278
    gam 0.1000086 0.1890853
...
```
    ...
    ─────────────────────────────────────
            score     weight
    glm 0.1076459 0.95057249
    gam 0.1082422 0.04942751

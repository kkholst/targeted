...
```
    ...
    ─────────────────────────────────────
              score    weight
    glm1 0.09832995 0.3327407
    glm2 0.10691888 0.1291057
    gam  0.09772598 0.5381536
...
```
    ...
    <bytecode: 0x559c48d3e3d0>
    <environment: 0x559c452007a8>
...
```
    ...
    5-fold cross-validation with 2 repetitions
               ...
               mse       mae
    glm 0.10710377 0.2123702
    gam 0.09769802 0.1874744
...
```
    ...
    ─────────────────────────────────────
            score     weight
    glm 0.1111335 0.94691358
    gam 0.1118590 0.05308642

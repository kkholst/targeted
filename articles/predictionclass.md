...
```
    ...
    ─────────────────────────────────────
              score     weight
    glm1 0.09698047 0.53795260
    glm2 0.10669864 0.09761238
    gam  0.09807671 0.36443502
...
```
    ...
    <bytecode: 0x556cbc6ccbd0>
    <environment: 0x556cb8dd0c68>
...
```
    ...
    5-fold cross-validation with 2 repetitions
               ...
               mse       mae
    glm 0.10730199 0.2127872
    gam 0.09567799 0.1856960
...
```
    ...
    ─────────────────────────────────────
            score    weight
    glm 0.1083406 0.1916811
    gam 0.1080221 0.8083189

...
import os
import sys
import targeted_template


file_loc = os.path.split(__file__)[0]
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(file_loc), '../../src/targeted_template')))
# sys.path.insert(0, os.path.abspath('../../src/'))

# -- Project information -----------------------------------------------------

project = 'targeted_template'
copyright = u'2019-2022, Klaus Kähler Holst'
author = u'Klaus Kähler Holst'
# The full version, including alpha/beta/rc tags

release = targeted_template.__version__
...
htmlhelp_basename = 'targeted_template_doc'

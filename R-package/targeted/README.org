...
#+PROPERTY: header-args :eval yes :exports both :Cresults output :tangle yes :comments yes
...
#+HTML: <a href="https://cran.r-project.org/package=targeted"><img src="http://www.r-pkg.org/badges/version/targeted"></a>
#+HTML: <a href="http://cranlogs.r-pkg.org/downloads/total/last-month/targeted"><img src="https://www.r-pkg.org/badges/version-last-release/targeted"></a>
...
#+RESULTS:
#+begin_example
riskreg(formula = y ~ a, nuisance = ~x
z, data = d, type = "rr")

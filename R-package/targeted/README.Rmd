...
<!-- badges: start -->
  [![travis](https://travis-ci.com/kkholst/targeted.svg?branch=master)](https://travis-ci.com/kkholst/targeted)
  [![coverage](https://codecov.io/github/kkholst/targeted/coverage.svg?branch=master)](https://app.codecov.io/github/kkholst/targeted?branch=master)
